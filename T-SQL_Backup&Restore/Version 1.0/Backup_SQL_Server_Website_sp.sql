...
CREATE OR ALTER PROC Backup_SQL_Server_Website
  ...
  @Backup_Threshould int = 0,							-- Change this number in accordance with your preference. This option of this script
															-- can be used only on SQL Server 2016 and later though.
  @Backup_root nvarchar(120) = N'D:\Website Backup',
  @Website_root nvarchar(120) = N'C:\inetpub\wwwroot', -- Default for Microsoft IIS home folder
...
BEGIN
  ...
  IF RIGHT(@Website_root, 1) = '\' 
  	SET @Website_root = 
  	left(@Website_root,(len(@Website_root)-1))
  ...
  Declare @Back_Path nvarchar(150) = @Backup_root + '\' + @dbname + '_' + @Back_DateandTime
