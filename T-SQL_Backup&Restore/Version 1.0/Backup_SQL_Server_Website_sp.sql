...
CREATE OR ALTER PROC Restore_SQL_Server_Website

  @Source_Backup_Database_Name nvarchar(128) = N'AdventureWorks2019',	-- Use the name of the website's db you wish to restore
  ...
  @Archive_File_Password nvarchar(15) = N'1234',			-- Use only characters and numbers. If you enter the password wrong, this script will raise error
  @Keep_Database_in_Restoring_State bit = 1,				-- If equals to 1, the database will be kept in restoring state until the whole process of restoring
