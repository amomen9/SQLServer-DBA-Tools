...
This script performs a full backup of the database and home folder files of the intended website. For full guide please refer to
the README.md file beside this file on the repository.
