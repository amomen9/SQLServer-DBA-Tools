...
-- Description:         "msdb backup history"
...
WHERE destination_database_name = 'PooyaFinance_MigrationStage'
--AND restore_type = 'D'
...
DECLARE @dbname sysname, @days int
SET @dbname = 'PooyaFinance_MigrationStage' --substitute for whatever database name you want
SET @days = -30 --previous number of days, script will default to 30
SELECT
