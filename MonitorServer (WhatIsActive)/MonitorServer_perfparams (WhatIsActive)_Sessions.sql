...
DROP FUNCTION IF EXISTS fn_udtvf_monitorserver_perfparams
GO
...
CREATE FUNCTION fn_udtvf_monitorserver_perfparams()
RETURNS TABLE
AS
RETURN
(
...
--EXEC sys.sp_who2		--3 14%

--EXEC sys.sp_who			--1 0%

EXEC sp_whoisactive		--9 45%
